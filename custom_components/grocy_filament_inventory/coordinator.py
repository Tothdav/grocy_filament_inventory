...
from .const import FIELD_PRODUCT_KEY, FIELD_PRODUCT_GROUP_ID, FIELD_PRODUCT_ID, FIELD_PRODUCT_USERFIELDS, FIELD_PARENT_PRODUCT_ID

_LOGGER = logging.getLogger(__name__)

class GrocyCoordinator(DataUpdateCoordinator):
    def __init__(self, hass, client: GrocyApi, group_id):
        super().__init__(
            hass,
            _LOGGER,
    ...
    async def _async_update_data(self):
        ...
        try:
            ...
            for product_in_stock in products_in_stock:
                if product_in_stock[FIELD_PRODUCT_KEY][FIELD_PRODUCT_GROUP_ID] == self.group_id and product_in_stock[FIELD_PRODUCT_KEY][FIELD_PARENT_PRODUCT_ID] is None:
